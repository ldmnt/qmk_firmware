...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_4,    KC_5,    KC_6,    KC_0,    _______,
...
const uint16_t PROGMEM combo_wef[] = {KC_E, KC_F, KC_W, COMBO_END};
const uint16_t PROGMEM combo_oij[] = {KC_O, KC_I, KC_J, COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO(combo_ij, KC_RGUI),
    COMBO(combo_wef, LGUI(KC_LCTL)),
    COMBO(combo_oij, RGUI(KC_RCTL)),
